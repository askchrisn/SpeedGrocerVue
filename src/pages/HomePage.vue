...
<script setup lang="ts">
  ...
  const groceryLists = [ 
    new GroceryList('Home', ['butter', 'milk', 'eggs'], ['conno1234@gmail.com']),
    new GroceryList('Work', ['butter', 'milk'], ['conno1234@gmail.com']),
    new GroceryList('Other', ['butter'], ['conno1234@gmail.com']),
  ]
</script>
